...
public class RVDAO implements CRUD {
    ...
    public List listar() {
        ...
        List<RV> lista = new ArrayList<>();
        String sql = "select * from registrar";//Consulra para cliente
        try {
            con = cn.Conectar();
            ...
            while (rs.next()) {
                ...
                c.setIdv(rs.getInt(3));
                
                c.setPv(rs.getDouble(4));
                c.setCan(rs.getInt(5));
                c.setTot(rs.getDouble(6));
